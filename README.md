...
Following are the endpoints exposed by the webserve.
...
5. For creating an empty user cart for a user, POST URL : /rest/user/cart 
   sample payload : 
<user>
  <name>Gagan</name>
  <email>gagan371@gmail.com</email>
</user>
6. For Adding an Item to the cart , POST URL : /rest/user/{emailid}/cart/product
 {emailId} is the user emailid , uniquely identifying the user in application
 sample payload :
    <cartitem>
